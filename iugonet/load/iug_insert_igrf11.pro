...
;  iug_insert_igrf11
;-
pro iug_insert_igrf11,coordinate_system=coordinate_system,yyyy=yyyy,glat=glat,glon=glon,height=height,d_ec=d_ec,d_ecm=d_ecm,i_nc=i_nc,i_ncm=i_ncm,h=h,x=x,y=y,z=z,f=f,d_sv=d_sv,i_sv=i_sv,h_sv=h_sv,x_sv=x_sv,y_sv=y_sv,z_sv=z_sv,f_sv=f_sv
