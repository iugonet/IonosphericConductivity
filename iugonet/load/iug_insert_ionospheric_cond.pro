...
;
  ...
  openw, unit, tmp_dir+'insert_ionospheric_cond.sql', /get_lun ; create query file
  ...
  spawn,'sqlite3 ${UDASPLUS_HOME}/iugonet/load/ionospheric_cond.db < '+tmp_dir+'/insert_ionospheric_cond.sql'
end
