...
;
        ...
        device, filename=tmp_dir+'ionospheric_cond_map_'+str_yyyy+'-'+str_mm+'-'+str_dd+'T'+str_time+'_'+str_ltut+'_'+str_height+'_'+str_sigma_type+'.eps', /color, /encapsulated, ysize=9
