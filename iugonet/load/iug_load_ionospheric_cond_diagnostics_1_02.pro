...
;
  ...
  for i=0L,n_elements(book_te_array_n2)-1 do begin
     ...
     printf, unit, t_e, book_nu_e_n2[i], nu_e_n2[i], (nu_e_n2[i]-book_nu_e_n2[i])/book_nu_e_n2[i]*100., $
...
;
  ...
  for i=0L,n_elements(book_te_array_o2)-1 do begin
     ...
     printf, unit, t_e, book_nu_e_o2[i],nu_e_o2[i],(nu_e_o2[i]-book_nu_e_o2[i])/book_nu_e_o2[i]*100., $
             format='(e10.2,e10.2,e10.2,i4)'
  endfor
  free_lun, unit
;
...
;
  ...
  for i=0L,n_elements(book_te_array_o)-1 do begin
     ...
     printf, unit, t_e, book_nu_e_o[i],nu_e_o[i],(nu_e_o[i]-book_nu_e_o[i])/book_nu_e_o[i]*100., $
             format='(e10.2,e10.2,e10.2,i4)'
  endfor
  free_lun, unit
;
...
;
  ...
  for i=0L,n_elements(book_te_array_h)-1 do begin
     ...
     printf, unit, t_e, book_nu_e_h[i],nu_e_h[i],(nu_e_h[i]-book_nu_e_h[i])/book_nu_e_h[i]*100., $
             format='(e10.2,e10.2,e10.2,i4)'
  endfor
  free_lun, unit
;
...
;
  ...
  for i=0L,n_elements(book_te_array_he)-1 do begin
     ...
     printf, unit, t_e, book_nu_e_he[i],nu_e_he[i],(nu_e_he[i]-book_nu_e_he[i])/book_nu_e_he[i]*100., $
             format='(e10.2,e10.2,e10.2,i4)'
  endfor
  free_lun, unit
