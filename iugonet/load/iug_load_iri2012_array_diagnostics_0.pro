...
;
  ...
  iug_load_iri2012, yyyy=yyyy, mmdd=mmdd, ltut=ltut, time=time, glat=glat, glon=glon, $
                    height_bottom=height_bottom, height_top=height_top, height_step=height_step, $
                    result=result_iri
...
;
  ...
  iug_load_iri2012, yyyy=yyyy, mmdd=mmdd, ltut=ltut, time=time, glat=glat, glon=glon, $
                    height_bottom=height_bottom, height_top=height_top, height_step=height_step, result=result_iri
...
; 1992-01-01, LT0, (0,0)
  ...
  for i=0L,n_elements(a)-1 do begin
     printf, unit, a[i], result_iri[i,1]*1.e6,b[i],(result_iri[i,1]*1.e6-b[i])/b[i]*100., $
             format='(i4,e10.2,e10.2,f8.4)'
  endfor
  free_lun,unit
;
;
