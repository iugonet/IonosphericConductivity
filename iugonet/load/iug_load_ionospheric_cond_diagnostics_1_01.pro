...
;
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result1.txt',/get_lun
...
; Height Integrated conductivities
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result5.txt',/get_lun
...
;
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result2.txt',/get_lun
  num_height = (height_top-height_bottom)/height_step+1
  for i=0L,num_height-1 do begin
     printf,unit,height[i], $
            takeda0[i],result[i,0],(result[i,0]-takeda0[i])/takeda0[i]*1.E2, $
...
; Height Integrated conductivities
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result6.txt',/get_lun
  printf,unit,"s0=",s0_takeda,result2d[0],(result2d[0]-s0_takeda)/s0_takeda*1.E2, $
         format='(a4,e10.2,e10.2,i5)'
  printf,unit,"s1=",s1_takeda,result2d[1],(result2d[1]-s1_takeda)/s1_takeda*1.E2, $
         format='(a4,e10.2,e10.2,i5)'
...
;
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result3.txt',/get_lun
  num_height = (height_top-height_bottom)/height_step+1
  for i=0L,num_height-1 do begin
     printf,unit,height[i], $
            takeda0[i],result[i,0],(result[i,0]-takeda0[i])/takeda0[i]*1.E2, $
...
; Height Integrated conductivities
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result7.txt',/get_lun
  printf,unit,"s0=",s0_takeda,result2d[0],(result2d[0]-s0_takeda)/s0_takeda*1.E2, $
         format='(a4,e10.2,e10.2,i5)'
  printf,unit,"s1=",s1_takeda,result2d[1],(result2d[1]-s1_takeda)/s1_takeda*1.E2, $
         format='(a4,e10.2,e10.2,i5)'
...
; 
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result4.txt',/get_lun
  num_height = (height_top-height_bottom)/height_step+1
  for i=0L,num_height-1 do begin
     printf,unit,height[i], $
            takeda0[i],result[i,0],(result[i,0]-takeda0[i])/takeda0[i]*1.E2, $
...
; Height Integrated conductivities
  ...
  openw,unit,'/tmp/iug_load_ionospheric_cond_diagnostics_1_01_result8.txt',/get_lun
  printf,unit,"s0=",s0_takeda,result2d[0],(result2d[0]-s0_takeda)/s0_takeda*1.E2, $
         format='(a4,e10.2,e10.2,i5)'
  printf,unit,"s1=",s1_takeda,result2d[1],(result2d[1]-s1_takeda)/s1_takeda*1.E2, $
         format='(a4,e10.2,e10.2,i5)'
