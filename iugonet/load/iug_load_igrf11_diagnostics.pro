pro iug_load_igrf11_diagnostics
  ; initialize
  spawn,'mv ${UDASPLUS_HOME}/iugonet/load/iug_igrf11.db ${UDASPLUS_HOME}/iugonet/load/iug_igrf11.db.tmp' ; escape for testing
  spawn,'sqlite3 ${UDASPLUS_HOME}/iugonet/load/iug_igrf11.db < ${UDASPLUS_HOME}/iugonet/load/iug_igrf11.sql'
  ...
  ; finalize
  spawn,'mv ${UDASPLUS_HOME}/iugonet/load/iug_igrf11.db.tmp ${UDASPLUS_HOME}/iugonet/load/iug_igrf11.db'
