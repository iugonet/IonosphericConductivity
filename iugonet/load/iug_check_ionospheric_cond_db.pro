...
;
  ...
  spawn,'sqlite3 ${UDASEXTRA_HOME}/iugonet/load/ionospheric_cond.db "'+query+'"',sigma_0
  ...
  query = "SELECT sigma_1 FROM ionospheric_cond WHERE height="+string(height) $
          ...
          +" and ltut="+string(ltut)+" and atime="+string(atime) $
          +" and algorithm="+string(algorithm)
  spawn,'sqlite3 ${UDASEXTRA_HOME}/iugonet/load/ionospheric_cond.db "'+query+'"',sigma_1
  ...
  query = "SELECT sigma_2 FROM ionospheric_cond WHERE height="+string(height)$
          ...
          +" and ltut="+string(ltut)+" and atime="+string(atime) $
          +" and algorithm="+string(algorithm)
  spawn,'sqlite3 ${UDASEXTRA_HOME}/iugonet/load/ionospheric_cond.db "'+query+'"',sigma_2
  ...
  query = "SELECT sigma_xx FROM ionospheric_cond WHERE height="+string(height)$
          ...
          +" and ltut="+string(ltut)+" and atime="+string(atime) $
          +" and algorithm="+string(algorithm)
  spawn,'sqlite3 ${UDASEXTRA_HOME}/iugonet/load/ionospheric_cond.db "'+query+'"',sigma_xx
  ...
  query = "SELECT sigma_yy FROM ionospheric_cond WHERE height="+string(height)$
          ...
          +" and ltut="+string(ltut)+" and atime="+string(atime) $
          +" and algorithm="+string(algorithm)
  spawn,'sqlite3 ${UDASEXTRA_HOME}/iugonet/load/ionospheric_cond.db "'+query+'"',sigma_yy
  ...
  query = "SELECT sigma_xy FROM ionospheric_cond WHERE height="+string(height)$
          ...
          +" and ltut="+string(ltut)+" and atime="+string(atime) $
          +" and algorithm="+string(algorithm)
  spawn,'sqlite3 ${UDASEXTRA_HOME}/iugonet/load/ionospheric_cond.db "'+query+'"',sigma_xy
