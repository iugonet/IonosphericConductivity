...
;
  ...
  set_plot,'ps'
  device,filename='iug_load_ionospheric_cond_diagnostics_3_00_result1.ps',/color
...
;
  ...
  set_plot,'ps'
  device,filename='iug_load_ionospheric_cond_diagnostics_3_00_result2.ps',/color
...
; 
  ...
  set_plot,'ps'
  device,filename='iug_load_ionospheric_cond_diagnostics_3_00_result3.ps',/color
...
;
  ...
  set_plot,'ps'
  device,filename='iug_load_ionospheric_cond_diagnostics_3_00_result4.ps',/color
