...
pro iug_load_ionospheric_cond_part1_old, height_bottom=height_bottom, height_top=height_top, height_step=height_step, glat=glat, glon=glon, yyyy=yyyy, mmdd=mmdd, ltut=ltut, time=time, result=result
...
; result[6,*]: height
     ...
     result[0,i] = e_charge^2. * ( result_iri(i,1) * 1.E6 )/(m_e * nu_e)
