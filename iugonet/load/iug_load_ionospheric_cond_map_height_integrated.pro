...
; plotting
  for m=0L, 5 do begin          ; for sigma_0, sigma_1, sigma_2, sigma_xx, sigma_yy, sigma_xy
     ...
     if m eq 0 then begin
        str_title = 'Height Integrated Ionospheric Conductivity, !4r!X!L0!n, !C'+str_yyyy+'-'+str_mmdd+'-'+str_time+str_ltut+', '+str_height+' km'
        str_sigma_type = 'sigma_0'
     endif else if m eq 1 then begin
        str_title = 'Heignt Integrated Ionospheric Conductivity, !4r!X!L1!n, !C'+str_yyyy+'-'+str_mmdd+'-'+str_time+str_ltut+', '+str_height+' km'
        str_sigma_type = 'sigma_1'
     endif else if m eq 2 then begin
        str_title = 'Height Integrated Ionospheric Conductivity, !4r!X!L2!n, !C'+str_yyyy+'-'+str_mmdd+'-'+str_time+str_ltut+', '+str_height+' km'
        str_sigma_type = 'sigma_2'
     endif else if m eq 3 then begin
        str_title = 'Height Integrated Ionospheric Conductivity, !4r!X!Lxx!n, !C'+str_yyyy+'-'+str_mmdd+'-'+str_time+str_ltut+', '+str_height+' km'
        str_sigma_type = 'sigma_xx'
     endif else if m eq 4 then begin
        str_title = 'Height Integrated Ionospheric Conductivity, !4r!X!Lyy!n, !C'+str_yyyy+'-'+str_mmdd+'-'+str_time+str_ltut+', '+str_height+' km'
        str_sigma_type = 'sigma_yy'
     endif else if m eq 5 then begin
        str_title = 'Heignt Integrated Ionospheric Conductivity, !4r!X!Lxy!n, !C'+str_yyyy+'-'+str_mmdd+'-'+str_time+str_ltut+', '+str_height+' km'
